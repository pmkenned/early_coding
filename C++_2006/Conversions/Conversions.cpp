...
#define INVALID "You have entered an invalid number"
  ...
  switch ((int) userinput)
  {
    ...
    switch ((int) userinput)
    {
      ...
      switch ((int) userinput)
      {
        ...
        cout << "Enter miles: ";
        cin >> userinput;
        cout << ""<< userinput <<" miles equals "<<userinput * 1.609 <<" kilometers\n";
        break;
      ...
      switch ((int) userinput)
      {
        ...
        cout << "Enter pounds: ";
        cin >> userinput;
        cout << ""<< userinput <<" pounds equals "<< userinput * .4536 <<" kilograms\n";
        break;
